...
export class StationComponent implements OnInit, OnDestroy {
  ...
  constructor(public stationService: StationService, public sensorService: SensorService, private onlineService: OnlineClientService, private router: Router,
     private route: ActivatedRoute, public busyService: BusyService, private modalService: ModalService, private injector : Injector) {
  ...
  showNotificationWindow = () => {
    this.modalService.showCreateNotificationModal(this.injector.get(AppComponent).wraper, this.stationId).subscribe(res => console.log(res));
  }
